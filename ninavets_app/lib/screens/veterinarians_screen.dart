...
class _VeterinariansScreenState extends State<VeterinariansScreen> {
  ...
  void initState() {
    super.initState();
    _veterinariansFuture = AuthService.fetchVeterinarians();
  }
      ...
      body: FutureBuilder<List<User>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
              child: Text(
                'Ocorreu um erro ao carregar os veterinários',
          ...
          if (veterinarians.isEmpty) {
            return const Center(
              child: Text(
                'Ainda não existem veterinários registados.',
                textAlign: TextAlign.center,
              ),
            );
          }
          ...
          return RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                final user = veterinarians[index];
                return Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () => _openAppointmentSheet(user),
                  ),
                );
              },
            ),
  ...
  Future<void> _openAppointmentSheet(User veterinarian) async {
    final request = await showModalBottomSheet<_AppointmentRequest>(
      ...
      builder: (_) => _AppointmentRequestSheet(veterinarian: veterinarian),
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Pedido enviado para ${veterinarian.name}. Será notificado em breve.',
        ),
      ),
    );
  }
...
class _AppointmentRequestSheet extends StatefulWidget {
  const _AppointmentRequestSheet({required this.veterinarian});
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Veterinário: ${widget.veterinarian.name}'),
